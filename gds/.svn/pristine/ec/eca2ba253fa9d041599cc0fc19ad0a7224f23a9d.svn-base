...
@Component({
  selector: 'app-mdm-role',
  templateUrl: './mdm-role.component.html',
  styleUrls: ['../scss/mdm_common.scss', './mdm-role.component.scss']
})


export class MdmRoleComponent implements OnChanges, OnInit {
