...
@Component({
    selector: 'app-mdm-frequency',
    templateUrl: './mdm-frequency.component.html',
    styleUrls: ['../scss/mdm_common.scss', './mdm-frequency.component.scss']
})
export class MdmFrequencyComponent implements OnChanges, OnInit {
...
export const errorMessages: { [key: string]: string } = {
    ...
    frequency: "Sum of Data Sumbission Days and Data Review Days should be less than 28 Days"
};
