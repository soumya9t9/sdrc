...
@Component({
    selector: 'app-mdm-department',
    templateUrl: './mdm-department.component.html',
    styleUrls: ['../scss/mdm_common.scss', './mdm-department.component.scss']
})


export class MdmDepartmentComponent implements OnChanges, OnInit {
