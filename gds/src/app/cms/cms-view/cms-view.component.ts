...
export class CmsViewComponent implements OnChanges, OnInit {
    ...
    getUrlParams() {
        ...
        this.route.paramMap.subscribe(params => {
            this.routedParam = params.get('mdmType');
        ...
        if (this.selectedSectionData && this.selectedSectionData.leftsubmenuName === "District") {
            ...
            reader.onload = function (event: any) {
                ...
                if (!miltipleCode && !miltipleName && codeAndNamePairExists == 1) {
                    ...
                    // const dialogRef = $that.dialog.open(ConfirmationDailogComponent,
                    //     { width: '400px', disableClose: true, data: { msg: distErrorMessage, button: "Ok" } });
