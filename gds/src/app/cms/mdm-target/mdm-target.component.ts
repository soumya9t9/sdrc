...
@Component({
    selector: 'app-mdm-target',
    templateUrl: './mdm-target.component.html',
    styleUrls: ['../scss/mdm_common.scss', './mdm-target.component.scss']
})


export class MdmTargetComponent implements OnChanges, OnInit {
                ...
                switch ($event.leftsubmenuName) {
                    ...
                    case "Target-Value":
                        ...
                        if (departmentWiseIndicators.length) {
                            ...
                            !this.selectedDepartment ? this.selectedDepartment = this.departmentList[0].departmentId : '';
                        }
                        break;
                }
